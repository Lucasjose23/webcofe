    ...
    <article class="container-login center-block">
		<section>
			<ul id="top-bar" class="nav nav-tabs nav-justified">
				<li ><a href="Default.aspx">Produtor</a></li>
				<li class="active"><a href="Default2.aspx">Cooperativa</a></li>
			</ul>
			<div class="tab-content tabs-login col-lg-12 col-md-12 col-sm-12 cols-xs-12">
				<div id="login-access" class="tab-pane fade active in">
					<h2><i class="glyphicon glyphicon-briefcase "></i> Cooperativa</h2>						
					
						<div runat="server" id="DivLoginCoop" class="form-group ">
                        ...
                        <div runat="server" id="DivCadCoop" class="form-group ">
                            <label for="login" class="sr-only">CNPJ:</label>
                            <asp:TextBox ID="TextBoxCNPJ" runat="server" class="form-control" placeholder="CNPJ"></asp:TextBox>
                            <br/>	
                            ...
                            <br/>	
                            <label for="login" class="sr-only">Descrição</label>
                            <asp:TextBox ID="TextBoxDESCRI" runat="server" class="form-control" placeholder="Descrição"></asp:TextBox>
                            <br/>	
                            <label for="login" class="sr-only">Site:</label>
